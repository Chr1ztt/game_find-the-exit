...
//        stringInput.close();
        ...
        do{
            ...
            System.out.println("1. FindTheExit");
            System.out.println("insert your choice : ");
//            scanner.nextLine();
            menu = scanner.nextInt();
            switch(menu){
                case 1 :
                    game = new FindTheExitGame();
                    break;
                case 2 : 
...
//            scanner.nextLine();
            ...
            do {          
                game.init();
                game.play();
                System.out.print("do you want to play this game again or chooose another game? (y/n) :");
                isPlayAgain = stringScanner.nextLine();
